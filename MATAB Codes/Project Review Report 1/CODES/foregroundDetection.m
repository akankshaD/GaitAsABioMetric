...
videoSource = vision.VideoFileReader('C:\Users\Akanksha\Desktop\Project\Dataset\videos\test30.MOV','ImageColorSpace','Intensity','VideoOutputDataType','uint8');
...
while ~isDone(videoSource)
     ...
     out = getframe(fm);
     filename = strcat('C:\Users\Akanksha\Documents\MATLAB\test30BBox\fg_',num2str(i),'.png');
