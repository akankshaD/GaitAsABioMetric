function [AFH] = temp1(mat_w, mat_h, total_rows, I, folderName, videoNum)
...
while j < size(I, 1);
    ...
    fh = hist3(Vec, [50 360]);    % Choosing 50 bins for r and 360 for theta
...
disp('Histogram Normalized Flow Calculation !')
for i=1:size(diff_fro_norm)
    disp(i);
    disp(diff_fro_norm(i));
end
